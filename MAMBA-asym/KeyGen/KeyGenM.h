...
public:
  ...
  void a_Input_self(vector<gfp> &in, vector<gfp> &out, vector<gfp> &mac_out, bigint p, MASCOTTriples &mt);

  void a_Input_other(int nbP_Input, vector<gfp> &out, vector<gfp> &mac_out, bigint p, MASCOTTriples &mt);
