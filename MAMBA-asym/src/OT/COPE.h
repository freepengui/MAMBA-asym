...
public:
  void init(Player &P, int i, unsigned int fsize, CryptoPP::RandomPool &RNG, unsigned int threadNb= 1);
...
public:
  void init(Player &P, int i, unsigned int fsize, gfp &delta, CryptoPP::RandomPool &RNG, unsigned int threadNb= 1);
