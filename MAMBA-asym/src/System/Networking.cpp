...
int OpenListener(int port, int max)
{
  ...
  // tv.tv_sec= 15;
  // tv.tv_usec= 0;
  // fl= setsockopt(sd, SOL_SOCKET, SO_RCVTIMEO, (const char *) &tv, sizeof(tv));
  // if (fl < 0)
  //   {
  //     throw Networking_error("OpenConnection: setsockopt : SO_RCVTIMO");
  //   }
...
int OpenConnection(const string &hostname, int port)
{
  ...
  // tv.tv_sec= 15;
  // tv.tv_usec= 0;
  // int fl= setsockopt(sd, SOL_SOCKET, SO_RCVTIMEO, (char *) &tv, sizeof(tv));
  // if (fl < 0)
  //   {
  //     throw Networking_error("OpenConnection: setsockopt : SO_RCVTIMO");
  //   }
