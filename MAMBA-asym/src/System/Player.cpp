                            ...
                            int connection) const
{
  ...
  int len_buff= 4;
  encode_length(szbuff, length);
  // cout << "send ssl size " << ssl.size() << "  i = " << player << endl;
  // cout << "send ssl[i] size " << ssl[player].size() << " connection = " << connection << endl;
  ...
  while (len - i > 0)
    {
      ...
      //        printf("SSL_READ error : %d : %d % d : Was trying to read % d bytes out\
	    //  of % d bytes /n",j,e0,e1,len-i,len);
            cout << "SSL_READ error: " << j << " : " << e0 << " " << e1 << " : Was trying to read " << len-i << " bytes out of " << len << "bytes" << endl;
             perror("Some Error" );
                                           ...
                                           int connection, bool verbose) const
{
  ...
  // cout << " ssl size " << ssl.size() << "  i = " << i << endl;
  // cout << " ssl[i] size " << ssl[i].size() << " connection = " << connection << endl; 
  // cout << "**********************************" << endl;
  ...
  buff.resize(length);
  // cout << " ssl size " << ssl.size() << "  i = " << i << endl;
  // cout << " ssl[i] size " << ssl[i].size() << " connection = " << endl;
